...
public class DListNode extends ListNode {
  ...
  public void insertAfter(Object item) throws InvalidNodeException {
    ...
    //   new node.
    DListNode newNode = ((DList) myList).newNode(item, (DList)this.myList, this, next);
  ...
  public void insertBefore(Object item) throws InvalidNodeException {
    ...
    //   what DList it's in.  You should use myList.newNode() to create the
    //   new node.
    DListNode newNode = ((DList) myList).newNode(item, (DList)this.myList, prev, this);
    newNode.prev.next = newNode;    //the state of next or prev??? did I change them
    newNode.next = this;
    myList.size++;
  }
  ...
  public void remove() throws InvalidNodeException {
    ...
    //   "this" is null.  Remember that this node's "myList" field tells you
    //   what DList it's in.
      DListNode current = ((DList)myList).head;
	  DListNode prev = current;
	  current = current.next;
	  while(current != ((DList)myList).head) {     
		  if(current==this) {
			  prev = current.prev;
