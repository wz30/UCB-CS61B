...
public class DList2 {
  ...
  public void insertFront(int i) {
	  DListNode2 insertNode = new DListNode2(i);
	  if(size==0){    //head.next ==head.prev is wrong
		  ...
		  //if(head.next.next == insertNode.next) System.out.println("wei");
	  }
	  size++;
  }
  ...
  DListNode2 getHead(){
	  DListNode2 insertNode = new DListNode2();
